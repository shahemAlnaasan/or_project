...
class IncomingTransferReport extends StatefulWidget {
  ...
  @override
  State<IncomingTransferReport> createState() => _IncomingTransferReportState();
}

class _IncomingTransferReportState extends State<IncomingTransferReport> {
  final months = [
    'كانون الثاني', // Jan
    'شباط', // Feb
    'آذار', // Mar
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        AppText.bodyLarge(
          "${LocaleKeys.reports_incoming_transfers_count.tr()} ${LocaleKeys.reports_depend_on_year_monthes.tr()}",
        ...
        SizedBox(height: 20),
        AppText.bodyLarge(
          "${LocaleKeys.reports_incoming_transfers_count.tr()} ${LocaleKeys.reports_this_month.tr()}",
          textAlign: TextAlign.start,
          fontWeight: FontWeight.bold,
        ),
        SizedBox(height: 20),
